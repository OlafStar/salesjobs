...
const OfferDetailsModal = ({id}: {id: string}) => {
  const {data} = useAdvertisement(id);
  return (
    <div className="border border-[#f1f1f1] shadow-sm rounded-lg p-4 flex flex-col gap-4 min-h-screen-minus-88 relative">
...
export default memo(OfferDetailsModal);
